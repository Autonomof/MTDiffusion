...
# from vocoder_audioset.modules import Generator
...
#         if opt.name:
#             name = '_'+opt.name
#         elif opt.base: # config file ['/mnt/autonomf_4T/text-to-sound-Synthesis-master/Codebook/configs/caps_codebook.yaml']
...
#         logdir = os.path.join('/mnt/autonomf_4T/text-to-sound-Synthesis-master/Codebook/logs', nowname)
