...
class Unet(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.uvit = UViT(img_size=(24, 88), patch_size=4, in_chans=64, depth=2, num_classes=7,num_heads=8)
...
class BitDiffusion(nn.Module):
    ...
    def ddpm_sample(self, shape, labels, time_difference=None):
        ...
        for time, time_next in tqdm(time_pairs, desc='sampling loop time step', total=self.timesteps):
            ...
            x_start = self.model(img, noise_cond, labels)
    ...
    def ddim_sample(self, shape,labels, time_difference=None):
        ...
        for times, times_next in tqdm(time_pairs, desc='sampling loop time step'):
            ...
            x_start = self.model(img, log_snr, labels)
    ...
    def forward(self, img,labels, *args, **kwargs):
        ...
        pred = self.model(noised_img, noise_level, labels)
