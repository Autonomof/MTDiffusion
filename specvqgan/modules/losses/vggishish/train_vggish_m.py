...
from model import VGGishish, VGGishish_audio, VGGishish_audio_new
...
if __name__ == "__main__":
    ...
    #model = VGGishish_audio(cfg.conv_layers, cfg.use_bn, num_classes=527)
    model = VGGishish(cfg.conv_layers, cfg.use_bn, num_classes=307)
    print('model ',model)
    assert 1==2
